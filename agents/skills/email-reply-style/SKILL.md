...
- Don't hedge firm details with "ideally" or other wishy-washy qualifiers — state confirmed dates/times/terms directly (e.g. "Tuesday, July 28, 4–8pm", not "ideally July 28 from 4–8")
- Don't bury or soften the ask — make ONE clear, specific ask and lead with what's most valuable to Michael (e.g. "how many investors can you bring — especially tier-1?"), not a vague "let me know your thoughts"
...
- **2026-06-30 — Don't hedge firm details; make one clear, direct ask.** Drafting an outbound reply to a venue/partner (Founders Bay) about Open Batch Demo Day, the draft said "ideally it is July 28th from 4-8" and buried a vague ask. Michael: "don't say ideally" and "ask her something more clearly." Fixes: (1) state confirmed details directly — no "ideally"/hedge words on dates/times/terms; (2) make ONE specific ask and lead with what Michael most wants ("how many investors — especially tier-1?"). Also for partnership/sponsor negotiations: keep the event's own brand, offer the other side partner/sponsor visibility, and the close uses the **Open Batch 20-min** link (see Key Resources): "Feel free to grab a time here to discuss further (or ask me any other questions here): [link]". Both now in *What NOT to Do* above.
