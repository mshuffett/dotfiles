---
description: Use when working on the Sphere mobile app, React Native/Expo development, or user asks about "the mobile app" or "sphere".
---
...
- **Backend:** Supabase
- **AI Providers:** Claude Opus, Google Gemini, OpenAI, Vercel AI Gateway
...
- Metro worker processes: 6 x ~11 MB
...
- [ ] Dev server starts without errors (`pnpm run start`)
- [ ] App loads on phone via Expo Go or dev build
- [ ] AI chat streaming works with at least one provider
