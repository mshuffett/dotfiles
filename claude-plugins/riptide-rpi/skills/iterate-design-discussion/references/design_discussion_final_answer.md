...
- Document: [rpi/tasks/ENG-XXXX-description/YYYY-MM-DD-design-discussion.md](use `rpi permalink` command)
...
```text
use the create-structure-outline skill for [rpi/tasks/ENG-XXX-description]
```
