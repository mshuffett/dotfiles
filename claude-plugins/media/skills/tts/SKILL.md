---
name: Text-to-Speech
description: Use when generating speech audio, creating voiceovers, working with TTS, or making podcasts. Auto-loads when user asks to "generate speech", "create audio", "text to speech", "make a voiceover", "generate podcast", or mentions TTS providers (Inworld, Hume, Gemini TTS).
---
