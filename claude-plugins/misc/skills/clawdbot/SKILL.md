---
name: Clawdbot Configuration
description: Use when working with clawdbot, configuring messaging bindings, WhatsApp/iMessage/Telegram channels, or managing agent identities. Auto-load when user mentions clawdbot, messaging bots, or channel configuration.
---
