---
description: Documentation for programmatically controlling windows using Hammerspoon with hhtwm. Explains hybrid approach using hhtwm cache for context and direct Hammerspoon commands for precise control without triggering full retiling. Use when implementing Claude Code + Hammerspoon integration or creating custom window layouts.
---
...
Claude can execute these patterns using the `hs` command:
...
- Related idea: [[2025-10-05-claude-code-hammerspoon-integration]]
