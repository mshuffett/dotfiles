...
description: Use when generating WhatsApp replies for Michael, auto-replying to messages, or tuning message response style. Provides Michael's communication patterns and style guide.
---
