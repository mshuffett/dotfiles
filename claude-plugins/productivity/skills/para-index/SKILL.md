---
name: PARA Index
description: Use when organizing tasks, processing inbox items, or mapping items between Todoist, Notion, and Obsidian. Contains the unified PARA structure across all systems.
---
...
| 2360927142 | 🚢🏖️ Ship to Beach Dashboard | - |
| 2360927149 | 🚢🏖️ Sprint Execution | - |
...
| Folder | Description |
|--------|-------------|
| 🚢🏖️ Ship to Beach | Sprint dashboard project |
| DaVinci | AI project |
...
| File | Purpose |
|------|---------|
| 🏕️ Basecamp.md | Home base dashboard |
