...
2. Use feature-specific names, not generic ones (e.g., `daily-checkin-implementation.md` not `IMPLEMENTATION.md`)
3. Check if existing docs cover this - update them instead of creating new ones
4. Link new docs from README or parent doc (no orphaned files)
