...
```bash
node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js commit "fix($PHASE): revise plans based on checker feedback" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md
```
...
```bash
INIT=$(node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js init plan-phase "${PHASE}")
```
...
```bash
node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js history-digest
```
...
```bash
VALID=$(node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js frontmatter validate "$PLAN_PATH" --schema plan)
```
...
```bash
STRUCTURE=$(node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js verify plan-structure "$PLAN_PATH")
```
...
```bash
node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js commit "docs($PHASE): create phase plan" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md .planning/ROADMAP.md
```
</step>
