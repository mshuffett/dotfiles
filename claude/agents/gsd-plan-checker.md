...
```bash
INIT=$(node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js init phase-op "${PHASE_ARG}")
```
...
node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js roadmap get-phase "$phase_number"
...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  echo "=== $plan ==="
  PLAN_STRUCTURE=$(node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js verify plan-structure "$plan")
  echo "$PLAN_STRUCTURE"
done
```
...
```bash
MUST_HAVES=$(node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js frontmatter get "$PLAN_PATH" --field must_haves)
```
...
```bash
PLAN_STRUCTURE=$(node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js verify plan-structure "$PLAN_PATH")
```
