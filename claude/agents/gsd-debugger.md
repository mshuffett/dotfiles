...
```bash
INIT=$(node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js state load)
...
```bash
node /Users/michael/.claude/get-shit-done/bin/gsd-tools.js commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
